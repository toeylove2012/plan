                                                                    ...
                                                                    <form method="post" id="insert_form">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                id="mt_name" name="mt_name" require>
                                                                        </div>
        ...
        $(document).on('click', '.delete_data', function() {
            ...
            if (mt_id != '') {
                swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "maint_moneytype_delete.php",
                            method: "POST",
                            data: {
                                mt_id: mt_id
                            },
