...
Table-Budget
      ...
      $sql1 = "SELECT amount,installment FROM `running_balance` WHERE md_id = $md_id Group by md_id,installment"; 
        ...
        ?>
                ...
                $r++;  
                  ...
                  <tr>
                    ...
                    <?php 
													for($i=1;$i<=12;$i++){
                            $cur_bul = $con->query("SELECT sum(amount) as total FROM `running_balance` WHERE installment = $i")->fetch_assoc()['total']; 
														echo "<th>";
